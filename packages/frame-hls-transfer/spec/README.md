...
**Package**: `@mtngtools/frame-hls-transfer`

## Overview

This package handles the actual data movement for HLS operations. It is responsible for fetching content via HTTP and writing content to storage (local filesystem, etc.). It provides concrete implementations of the abstract interfaces defined in [`@mtngtools/utils-hls-types`](../../utils-hls-types/spec/README.md).
