...
## Package-specific agent guidance for `@mtngtools/utils-hls-types`

This file contains only package-specific guidance for automated agents working on the `@mtngtools/utils-hls-types` package. See below for additional guidance.
