...
## Package-specific agent guidance for `@mtngtools/utils-hls-core`

This file contains only package-specific guidance for automated agents working on the `@mtngtools/utils-hls-core` package. See below for additional guidance.
