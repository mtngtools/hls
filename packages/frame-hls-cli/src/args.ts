...
function printHelp(): void {
  console.log(`
Usage: hls-base <source> <destination> [options]
...
Examples:
  hls-base https://cdn1.com/main.m3u8 /local/output
  hls-base https://cdn1.com/main.m3u8 https://cdn2.com/ --max-concurrent 10
  hls-base https://cdn1.com/main.m3u8 /output --config config.json
`);
}
