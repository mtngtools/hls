...
## Package-specific agent guidance for `@mtngtools/utils-hls-parser`

This file contains only package-specific guidance for automated agents working on the `@mtngtools/utils-hls-parser` package. See below for additional guidance.
