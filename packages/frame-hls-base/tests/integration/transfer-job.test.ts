...
import { OfetchFetcher } from '@mtngtools/frame-hls-transfer';
import { DefaultPipelineExecutor } from '@mtngtools/frame-hls-base';
import { HlsParser } from '@mtngtools/frame-hls-base';
...
describe('TransferJobExecutor Integration Tests', () => {
  ...
  const fixturesDir = resolve(__dirname, '../../../utils-hls-parser/tests/fixtures');
