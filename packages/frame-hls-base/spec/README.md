...
**Package**: `@mtngtools/frame-hls-base`

## Overview

This package acts as the default entry point for most consumers. It combines the orchestration logic from [`@mtngtools/utils-hls-core`](../../utils-hls-core/spec/README.md) with the concrete implementations from [`@mtngtools/frame-hls-transfer`](../../frame-hls-transfer/spec/README.md) and default parsing via [`@mtngtools/utils-hls-parser`](../../utils-hls-parser/spec/README.md).
